...
import  { HoverTooltip}  from "../../main_page/tnx_details_page";
import TransactionKindViewer from "../../main_page/tnx_summary_helper/tnx_command_component";
import { TransactionSummary } from "../../main_page/tnx_ai_summary_comp";
import {TransactionInputView} from "./TransactionInputView"
import {tnx_commands} from "../../main_page/interfaces/ui_ready_interfaces/commands_ui_ready";
...
import { get_inputs ,checkandcomparefunctioneffect,balanceeffect,participants} from "../../main_page/data_transformation_functions.ts/effects";
import { get_tnx_commands } from "../../main_page/data_transformation_functions.ts/commands";
import { get_transaction_sender } from "../../main_page/data_transformation_functions.ts/sender";
import  CollapseSection  from "../../../components/ui/CollapseComponent";
const friendlyNames = [
...
export  function ProgrammableTxView( {transaction} : {transaction : TnxAnatomy}) {
...
<CollapseSection title="Transaction type ">
...
<CollapseSection title="Participants">
 ...
 <CollapseSection title="Initiator & Gas Details">   
...
<CollapseSection title="What the Transaction Did (In Order)">   
...
<CollapseSection title="How Balances Changed">   
...
<CollapseSection title="What Changed for Each Object">  
...
<div className="mt-2 text-white space-y-2">
  {object_effects?.map((effect, index) => (
    ...
    <CollapseSection title="Inputs Provided to the Transaction">  



    <div className="whitespace-pre-wrap leading-relaxed mb-5">
   <TransactionInputView tnx_inputs={tnx_inputs!} />
    </div>
    </CollapseSection>  
    </pre>
